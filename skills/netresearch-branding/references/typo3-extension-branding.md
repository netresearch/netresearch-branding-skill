...
- Use SVG **presentation attributes** (`fill="#2F99A4"`, `fill="currentColor"`, `fill-rule="evenodd"`), **never the `style="..."` attribute** — the `style` attribute breaks under a hardened TYPO3 backend CSP (`style-src-attr`).
