...
- Preferred source: `assets/logos/netresearch-symbol-only.svg`
- This copy mirrors the symbol geometry and preserves the original structure.
...
- Minimum rendered size: `32×32px`
- Recommended header size: `40–56px`
- Keep aspect ratio
